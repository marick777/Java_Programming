...
public class EvenlyDivisible {
    ...
    public static void main(String[] args) {
        ...
        // if the remainder of number by 2 is equal to zero, then it's evenly dividible by 2

        boolean isDivisibleBy3 = number % 3 == 0;
        // if the remainder of number by 3 is equal to zero, then it's evenly dividible by 3

        boolean isDivisibleBy5 = number % 5 == 0;
        // if the remainder of number by 5 is equal to zero, then it's evenly dividible by 5
