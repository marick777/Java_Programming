...
public class CombineAndSumOfNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------------------------------------------------");
        String st3 = combine2("java", "apple");
    ...
    public static String combine2(String st1, String st2) {
        String result;
        if (st1.charAt(st1.length() - 1) == st2.charAt(0)) { // if the last character of the first string is equal to
            // the first character of the second string
            result = st1 + st2.substring(1);
