...
public class SetDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> list = new ArrayList<>(); // accepts duplicates, keeps insertion order, hax index
        ...
        Set<Integer> set1 = new HashSet<>(); // order is random, accept null key
        ...
        Set<Integer> set2 = new LinkedHashSet<>(); //keeps insertion order. accept null key
